...
/***/ function(module, exports, __webpack_require__) {
	...
	var Song = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement('iframe', { src: 'https://embed.spotify.com/?uri={this.props.uri}', width: '300', height: '80', frameborder: '0', allowtransparency: 'true' });
	  }
	});
	...
	var ShowList = React.createClass({
	  ...
	  render: function render() {
	    ...
	    this.props.shows.forEach(function (show) {
	      shows.push(React.createElement(Show, { key: show.id, venue: show.venue.uri, name: show.displayName }));
	    });
	    return React.createElement(
	      'ul',
	      null,
	...
	var SearchBox = React.createClass({
	    ...
	    if (event.keyCode === 13) {
	      $.ajax({
	        ...
	        success: function success(response) {
	          ...
	          ReactDOM.render(React.createElement(ShowList, { shows: data.shows }), document.getElementById('showsContainer'));
	  ...
	  render: function render() {
	    return React.createElement('input', { type: 'text', id: 'city-search', placeholder: 'city', onKeyDown: this.search, ref: 'citySearch' });
	  }
	});
	...
	function init() {
	  if (document.getElementById('searchContainer')) {
	    ReactDOM.render(React.createElement(SearchBox, null), document.getElementById('searchContainer'));
	  }
	}
